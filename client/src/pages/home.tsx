...
>
        {/* Декоративный свиток с закрученными краями */}
        <div
          style={{
            width: "100%",
            maxWidth: "1400px",
          ...
          >
            ...
            >
              {modalType === "unregistered" ? (
                <div
                  style={{
                    animation: "smallKeyGlow 3.5s ease-in-out infinite",
                    transformOrigin: "center",
                    display: "inline-block",
                  }}
                >
                  <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    {/* Zamok */}
                    <g transform="translate(10, 20)">
                      <rect x="5" y="25" width="50" height="35" fill="url(#modalGoldGradientUnreg)" stroke="#B8860B" strokeWidth="2" />
                      <rect x="0" y="15" width="10" height="45" fill="url(#modalGoldGradientUnreg)" stroke="#B8860B" strokeWidth="2" />
                      <rect x="50" y="15" width="10" height="45" fill="url(#modalGoldGradientUnreg)" stroke="#B8860B" strokeWidth="2" />
                    ...
                    {/* Klyuch */}
                    <g transform="translate(65, 35) rotate(-15)">
                      <circle cx="0" cy="0" r="8" fill="none" stroke="url(#modalGoldGradientUnreg)" strokeWidth="3" />
                      <circle cx="0" cy="0" r="5" fill="url(#modalGoldGradientUnreg)" />
                      <rect x="-2" y="8" width="4" height="25" fill="url(#modalGoldGradientUnreg)" />
                      <rect x="-6" y="28" width="4" height="6" fill="url(#modalGoldGradientUnreg)" />
                      <rect x="2" y="30" width="4" height="4" fill="url(#modalGoldGradientUnreg)" />
                      <rect x="-6" y="35" width="4" height="4" fill="url(#modalGoldGradientUnreg)" />
                    </g>

                    <defs>
                      <linearGradient id="modalGoldGradientUnreg" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" style={{ stopColor: "#FFD700", stopOpacity: 1 }} />
                        <stop offset="50%" style={{ stopColor: "#FFA500", stopOpacity: 1 }} />
                        <stop offset="100%" style={{ stopColor: "#FFD700", stopOpacity: 1 }} />
                      </linearGradient>
                ...
                >
                  <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    {/* Zamok */}
                    <g transform="translate(10, 20)">
                      <rect x="5" y="25" width="50" height="35" fill="url(#modalGoldGradientSub)" stroke="#B8860B" strokeWidth="2" />
                      <rect x="0" y="15" width="10" height="45" fill="url(#modalGoldGradientSub)" stroke="#B8860B" strokeWidth="2" />
                      <rect x="50" y="15" width="10" height="45" fill="url(#modalGoldGradientSub)" stroke="#B8860B" strokeWidth="2" />
                      <rect x="20" y="35" width="20" height="25" fill="#8B4513" stroke="#654321" strokeWidth="1" />
                      <circle cx="12" cy="25" r="3" fill="#4A4A4A" />
                      <circle cx="48" cy="25" r="3" fill="#4A4A4A" />
                      <circle cx="30" cy="30" r="2" fill="#4A4A4A" />
                    ...
                    {/* Klyuch */}
                    <g transform="translate(65, 35) rotate(-15)">
                      <circle cx="0" cy="0" r="8" fill="none" stroke="url(#modalGoldGradientSub)" strokeWidth="3" />
                      <circle cx="0" cy="0" r="5" fill="url(#modalGoldGradientSub)" />
                      <rect x="-2" y="8" width="4" height="25" fill="url(#modalGoldGradientSub)" />
                      <rect x="-6" y="28" width="4" height="6" fill="url(#modalGoldGradientSub)" />
                      <rect x="2" y="30" width="4" height="4" fill="url(#modalGoldGradientSub)" />
                      <rect x="-6" y="35" width="4" height="4" fill="url(#modalGoldGradientSub)" />
                    </g>

                    <defs>
                      <linearGradient id="modalGoldGradientSub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" style={{ stopColor: "#FFD700", stopOpacity: 1 }} />
                        <stop offset="50%" style={{ stopColor: "#FFA500", stopOpacity: 1 }} />
                        <stop offset="100%" style={{ stopColor: "#FFD700", stopOpacity: 1 }} />
                      </linearGradient>
